...
def get_score():
    ...
    print(f"▶️ 받은 요청 - 닉네임: {nickname}, 클래스: {character_class}, 총스탯: {total_status}, 특성: {status_special}, 가속: {status_haste}")
